    ...
    <main role="main">
      <article>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Key tasks</strong>, such as registration, search, submit,
              or checkout processes. Include all steps involved to complete each
              task.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            The generally accepted target for accessibility is the latest
            version of{" "}
          ...
          <p>
            Note that in some cases, some Level AAA success criteria may be
            fairly easy to meet. For example, refining appropriate link text
            (2.4.4, Level A) and heading structure (2.4.10, Level AAA) may be
            easy to address together when revising content.
          </p>
        </section>
      </article>
    </main>
